            ...
            >
              ...
              <div
                className="w-full relative overflow-hidden rounded-2xl
                           ...
                           hover:-translate-y-1.5 hover:shadow-[0_16px_48px_rgba(0,0,0,0.28)]
                           transition-all duration-300 group"
                style={{
                  aspectRatio: step.cert ? "4/3" : "4/3",
                  background: step.cert ? "rgba(255,255,255,0.08)" : "rgba(0,0,0,0.15)",
                  ...(step.cert ? { display: "flex", alignItems: "center", justifyContent: "center", padding: 16 } : {}),
                }}
              >
                {/* Step number pill */}
                <div
                  className="absolute top-3 left-3 z-10 w-7 h-7 rounded-full flex items-center justify-content-center
                             bg-white/20 border border-white/50 backdrop-blur-sm
                             font-display font-extrabold text-white text-xs"
                ...
                <img
                  ...
                  className={`block transition-transform duration-500 group-hover:scale-105 ${
                    step.cert
                      ? "object-contain w-auto h-full max-w-full drop-shadow-xl"
