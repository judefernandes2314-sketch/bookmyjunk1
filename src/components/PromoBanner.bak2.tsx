    ...
    <section className="px-4 mt-6">
      <div className="container mx-auto max-w-6xl">
        <a
          ...
          className="block w-full focus:outline-none focus:ring-2 focus:ring-ring rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow bg-card border border-border"
