        ...
        {open && (
          ...
          >
            <div className="px-4 pb-4 pt-1">
              ...
              <a href="https://play.google.com/store" target="_blank" rel="noopener noreferrer" onClick={() => setOpen(false)} className="block mt-2 bg-primary text-primary-foreground text-center px-5 py-2.5 rounded-lg text-sm font-semibold">
                📲 Download App
              </a>
            </div>
          </motion.div>
