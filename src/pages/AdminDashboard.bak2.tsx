...
const AdminDashboard = () => {
  ...
  const PERMISSIONS = ["create_post", "edit_post", "delete_post", "publish_post", "import_json", "manage_users", "manage_roles", "edit_homepage"] as const;
                    ...
                    <table className="w-full text-sm min-w-[880px]">
                      <thead>
                        <tr className="border-b border-border bg-muted/50">
                          ...
                          <th className="text-left px-4 py-3 font-medium text-muted-foreground">Inquiry Type</th>
