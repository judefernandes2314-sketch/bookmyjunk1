...
const FounderCard = ({ founder }: { founder: FounderType }) => {
  ...
  return (
    ...
    >
      ...
      <p className="text-muted-foreground text-[15px] leading-[1.8] mt-5">{founder.bio}</p>
...
const Founders = () => {
  ...
  useEffect(() => {
    const onPopState = (event: PopStateEvent) => {
      ...
      sessionStorage.setItem("homeScrollTarget", "book");
      navigate("/", { replace: true, state: { _scrollTrigger: Date.now() } });
    };
