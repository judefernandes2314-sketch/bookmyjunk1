    ...
    <AnimatePresence>
      {visible && (
        ...
        >
          ...
          {/* Button */}
          <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] shadow-lg shadow-[#25D366]/30 group-hover:shadow-xl group-hover:shadow-[#25D366]/50 transition-shadow">
