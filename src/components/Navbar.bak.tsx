    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-border/50">
      <div className="container mx-auto flex items-center justify-between h-24 px-4">
        ...
        <div className="hidden md:flex items-center gap-7">
          ...
          <a href="/#book" target="_blank" rel="noopener noreferrer" className="border border-primary/60 text-primary px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary/5 transition-colors duration-200">
            Book Pickup
          </a>
        ...
        {open && (
          ...
          >
            <div className="px-4 pb-4 pt-1">
              ...
              <a href= "#bookingform" target="_blank" rel="noopener noreferrer" onClick={() => setOpen(false)} className="block mt-2 border border-primary/60 text-primary text-center px-5 py-2.5 rounded-lg text-sm font-semibold">
                Book Pickup
              </a>
              <a
                href="#"
