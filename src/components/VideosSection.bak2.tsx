                  ...
                  >
                    ...
                    >
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div
                          className="h-12 w-12 rounded-full flex items-center justify-center group-hover:scale-110 group-hover:bg-primary transition-all duration-300"
                          style={{ background: "rgba(0,189,136,0.20)" }}
                        >
                          <Play
                            className="h-5 w-5 ml-0.5 transition-colors duration-300 group-hover:text-white group-hover:fill-white"
                            style={{ color: "#00bd88", fill: "#00bd88" }}
                          />
                        </div>
                      </div>
                    </div>
