    ...
    <div className="container mx-auto px-6 md:px-10 relative z-10">
      ...
      <div className="flex flex-col md:flex-row md:items-start gap-6 md:gap-0">
        ...
        >
          ...
          {/* Phone frame — same height as IMAGE_HEIGHT */}
          <div style={{
            height: IMAGE_HEIGHT,
            width:  PHONE_WIDTH,
            background: "#111",
            borderRadius: 20,
            padding: 6,
            boxShadow: "0 0 0 2px rgba(255,255,255,0.15), 0 16px 48px rgba(0,0,0,0.45)",
            position: "relative",
            flexShrink: 0,
          }}>
            {/* Notch */}
            <div style={{
              ...
              width: 24, height: 4, background: "#2a2a2a", borderRadius: 3, zIndex: 3,
            }} />
            {/* Screen */}
            <div style={{
              width: "100%", height: "100%", background: "#f3d700",
              borderRadius: 15, overflow: "hidden", display: "flex",
              flexDirection: "column", padding: "16px 6px 6px", gap: 4,
            }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 2px", marginBottom: 3 }}>
                <div style={{ width: 26, height: 8, background: "#0a6e34", borderRadius: 3, opacity: 0.9 }} />
                <div style={{ width: 12, height: 12, background: "#0a6e34", borderRadius: "50%", opacity: 0.55 }} />
              </div>
              <div style={{ flex: 1, overflow: "hidden", borderRadius: 12 }}>
                <img src={appScreenshot} alt="BookMyJunk App" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
            </div>
          </div>
