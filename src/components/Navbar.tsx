    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/100 backdrop-blur-xl border-b border-border/50">
      <div className="container mx-auto flex items-center justify-between h-20 px-4">
        ...
        <div className="hidden md:flex items-center gap-7">
          ...
          <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="border border-primary/60 text-primary px-4 py-2 rounded-lg text-sm font-semibold hover:bg-primary/5 transition-colors duration-200">
            Book Pickup
          </a>
