...
const Arrow = () => (
  <motion.div
    ...
    className="flex-shrink-0 flex items-center justify-center
               ...
               backdrop-blur-md
               mx-4 mb-16 md:mb-16 my-4 md:my-0
        ...
        {steps.map((step, i) => (
          <>
            ...
            >
              ...
              <div
                className="w-full relative transition-transform duration-300 group-hover:-translate-y-1 flex items-center justify-center"
                style={{ aspectRatio: step.cert ? undefined : "4/3", height: step.cert ? 280 : undefined }}
              >
                <img
                  src={step.image}
                  alt={step.imageAlt}
                  ...
                  style={{
                    width:  step.cert ? 200 : "100%",
                    height: step.cert ? 280 : "100%",
                    objectFit: "contain",
              ...
              {/* Label — top-aligned so all titles sit on same line */}
              <div className="mt-4 px-1 w-full text-left">
                <p className="font-display font-bold text-white text-[15px] leading-snug">{step.title}</p>
                <p className="text-white/65 text-[12.5px] mt-2 leading-relaxed">{step.sub}</p>
              </div>
            </motion.div>
